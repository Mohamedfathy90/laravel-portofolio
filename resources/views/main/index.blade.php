...
<main>
            ...
            <section class="banner">
                    ...
                    <div class="row align-items-center justify-content-center justify-content-lg-between">
                        ...
                        <div class="col-xl-5 col-lg-6">
                            <div class="banner__content">
                                <h2 class="title wow fadeInUp" data-wow-delay=".2s"><span>{{$slider->title}}</h2>
                                <p class="wow fadeInUp" data-wow-delay=".4s">{{$slider->description}}</p>
                ...
                <div class="banner__video">
                    <a href="{{$slider->video}}" class="popup-video"><i class="fas fa-play"></i></a>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <ul class="about__icons__wrap">
                                ...
                                <li>
                                    <img class="light" src="storage/{{$image->url}}" alt="Illustrator">
                            ...
                            <div class="about__content">
                                ...
                                <div class="about__exp">
                                    <div class="about__exp__icon">
                                        <img src="{{'front'}}/assets/img/icons/about_icon.png" alt="">
                                    </div>
                ...
                <div class="container">
                    ...
                    <div class="row gx-0 services__active">
                        <div class="col-xl-3">
                            <div class="services__item">
                                <div class="services__thumb">
                                    <a href="services-details.html"><img src="{{'front'}}/assets/img/images/services_img01.jpg" alt=""></a>
                                </div>
                                <div class="services__content">
                                    <div class="services__icon">
                                        <img class="light" src="{{'front'}}/assets/img/icons/services_light_icon01.png" alt="">
                                        <img class="dark" src="{{'front'}}/assets/img/icons/services_icon01.png" alt="">
                                    </div>
                        ...
                        <div class="col-xl-3">
                            <div class="services__item">
                                <div class="services__thumb">
                                    <a href="services-details.html"><img src="{{'front'}}/assets/img/images/services_img02.jpg" alt=""></a>
                                </div>
                                <div class="services__content">
                                    <div class="services__icon">
                                        <img class="light" src="{{'front'}}/assets/img/icons/services_light_icon02.png" alt="">
                                        <img class="dark" src="{{'front'}}/assets/img/icons/services_icon02.png" alt="">
                                    </div>
                        ...
                        <div class="col-xl-3">
                            <div class="services__item">
                                <div class="services__thumb">
                                    <a href="services-details.html"><img src="{{'front'}}/assets/img/images/services_img03.jpg" alt=""></a>
                                </div>
                                <div class="services__content">
                                    <div class="services__icon">
                                        <img class="light" src="{{'front'}}/assets/img/icons/services_light_icon03.png" alt="">
                                        <img class="dark" src="{{'front'}}/assets/img/icons/services_icon03.png" alt="">
                                    </div>
                        ...
                        <div class="col-xl-3">
                            <div class="services__item">
                                <div class="services__thumb">
                                    <a href="services-details.html"><img src="{{'front'}}/assets/img/images/services_img04.jpg" alt=""></a>
                                </div>
                                <div class="services__content">
                                    <div class="services__icon">
                                        <img class="light" src="{{'front'}}/assets/img/icons/services_light_icon04.png" alt="">
                                        <img class="dark" src="{{'front'}}/assets/img/icons/services_icon04.png" alt="">
                                    </div>
                    ...
                    <div class="row work__process__wrap">
                        <div class="col">
                            <div class="work__process__item">
                                ...
                                <div class="work__process__icon">
                                    <img class="light" src="{{'front'}}/assets/img/icons/wp_light_icon01.png" alt="">
                                    <img class="dark" src="{{'front'}}/assets/img/icons/wp_icon01.png" alt="">
                                </div>
                        ...
                        <div class="col">
                            <div class="work__process__item">
                                ...
                                <div class="work__process__icon">
                                    <img class="light" src="{{'front'}}/assets/img/icons/wp_light_icon02.png" alt="">
                                    <img class="dark" src="{{'front'}}/assets/img/icons/wp_icon02.png" alt="">
                                </div>
                                <div class="work__process__content">
                        ...
                        <div class="col">
                            <div class="work__process__item">
                                ...
                                <div class="work__process__icon">
                                    <img class="light" src="{{'front'}}/assets/img/icons/wp_light_icon03.png" alt="">
                                    <img class="dark" src="{{'front'}}/assets/img/icons/wp_icon03.png" alt="">
                                </div>
                                <div class="work__process__content">
                        ...
                        <div class="col">
                            <div class="work__process__item">
                                ...
                                <div class="work__process__icon">
                                    <img class="light" src="{{'front'}}/assets/img/icons/wp_light_icon04.png" alt="">
                                    <img class="dark" src="{{'front'}}/assets/img/icons/wp_icon04.png" alt="">
                                </div>
                                <div class="work__process__content">
                                    ...
                                    <div class="portfolio__active">
                                        <div class="portfolio__item">
                                            <div class="portfolio__thumb">
                                                <img src="{{'front'}}/assets/img/portfolio/portfolio_img01.jpg" alt="">
                                            </div>
                                        ...
                                        <div class="portfolio__item">
                                            <div class="portfolio__thumb">
                                                <img src="{{'front'}}/assets/img/portfolio/portfolio_img02.jpg" alt="">
                                            </div>
                                            <div class="portfolio__overlay__content">
                                        ...
                                        <div class="portfolio__item">
                                            <div class="portfolio__thumb">
                                                <img src="{{'front'}}/assets/img/portfolio/portfolio_img03.jpg" alt="">
                                            </div>
                                            <div class="portfolio__overlay__content">
                                        ...
                                        <div class="portfolio__item">
                                            <div class="portfolio__thumb">
                                                <img src="{{'front'}}/assets/img/portfolio/portfolio_img04.jpg" alt="">
                                            </div>
                                            <div class="portfolio__overlay__content">
                                        ...
                                        <div class="portfolio__item">
                                            <div class="portfolio__thumb">
                                                <img src="{{'front'}}/assets/img/portfolio/portfolio_img05.jpg" alt="">
                                            </div>
                                            <div class="portfolio__overlay__content">
                                                <span>Web Development</span>
                                                <h4 class="title"><a href="portfolio-details.html">Banking Management System</a></h4>
                                        ...
                                        <div class="portfolio__item">
                                            <div class="portfolio__thumb">
                                                <img src="{{'front'}}/assets/img/portfolio/portfolio_img06.jpg" alt="">
                                            </div>
                                            <div class="portfolio__overlay__content">
                                                <span>Web Development</span>
                                                <h4 class="title"><a href="portfolio-details.html">Banking Management System</a></h4>
                                        ...
                                        <div class="portfolio__item">
                                            <div class="portfolio__thumb">
                                                <img src="{{'front'}}/assets/img/portfolio/portfolio_img07.jpg" alt="">
                                            </div>
                                            <div class="portfolio__overlay__content">
                                                <span>Web Development</span>
                                                <h4 class="title"><a href="portfolio-details.html">Banking Management System</a></h4>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <ul class="partner__logo__wrap">
                                <li>
                                    <img class="light" src="{{'front'}}/assets/img/icons/partner_light01.png" alt="">
                                    <img class="dark" src="{{'front'}}/assets/img/icons/partner_01.png" alt="">
                                </li>
                                <li>
                                    <img class="light" src="{{'front'}}/assets/img/icons/partner_light02.png" alt="">
                                    <img class="dark" src="{{'front'}}/assets/img/icons/partner_02.png" alt="">
                                </li>
                                <li>
                                    <img class="light" src="{{'front'}}/assets/img/icons/partner_light03.png" alt="">
                                    <img class="dark" src="{{'front'}}/assets/img/icons/partner_03.png" alt="">
                                </li>
                                <li>
                                    <img class="light" src="{{'front'}}/assets/img/icons/partner_light04.png" alt="">
                                    <img class="dark" src="{{'front'}}/assets/img/icons/partner_04.png" alt="">
                                </li>
                                <li>
                                    <img class="light" src="{{'front'}}/assets/img/icons/partner_light05.png" alt="">
                                    <img class="dark" src="{{'front'}}/assets/img/icons/partner_05.png" alt="">
                                </li>
                                <li>
                                    <img class="light" src="{{'front'}}/assets/img/icons/partner_light06.png" alt="">
                                    <img class="dark" src="{{'front'}}/assets/img/icons/partner_06.png" alt="">
                                </li>
                            </ul>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-lg-6 order-0 order-lg-2">
                            <ul class="testimonial__avatar__img">
                                <li><img src="{{'front'}}/assets/img/images/testi_img01.png" alt=""></li>
                                <li><img src="{{'front'}}/assets/img/images/testi_img02.png" alt=""></li>
                                <li><img src="{{'front'}}/assets/img/images/testi_img03.png" alt=""></li>
                                <li><img src="{{'front'}}/assets/img/images/testi_img04.png" alt=""></li>
                                <li><img src="{{'front'}}/assets/img/images/testi_img05.png" alt=""></li>
                                <li><img src="{{'front'}}/assets/img/images/testi_img06.png" alt=""></li>
                                <li><img src="{{'front'}}/assets/img/images/testi_img07.png" alt=""></li>
                            </ul>
                        </div>
                        <div class="col-xl-5 col-lg-6">
                ...
                <div class="container">
                    <div class="row gx-0 justify-content-center">
                        <div class="col-lg-4 col-md-6 col-sm-9">
                            <div class="blog__post__item">
                                <div class="blog__post__thumb">
                                    <a href="blog-details.html"><img src="{{'front'}}/assets/img/blog/blog_post_thumb01.jpg" alt=""></a>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-9">
                            <div class="blog__post__item">
                                <div class="blog__post__thumb">
                                    <a href="blog-details.html"><img src="{{'front'}}/assets/img/blog/blog_post_thumb02.jpg" alt=""></a>
                                    <div class="blog__post__tags">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-9">
                            <div class="blog__post__item">
                                <div class="blog__post__thumb">
                                    <a href="blog-details.html"><img src="{{'front'}}/assets/img/blog/blog_post_thumb03.jpg" alt=""></a>
                                    <div class="blog__post__tags">
